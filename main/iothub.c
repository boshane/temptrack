...
//#endif // SET_TRUSTED_CERT_IN_SAMPLES
            ...
            else
            {
                ...
                do
                {
                    ...
                    snprintf(tempString, len+1, "%f", temperature);
                    ...
                    {
                        sprintf_s(msgText, sizeof(msgText), "{\"deviceId\":\"foobar\",\"temperature\":%.2f}", temperature);
                        ...
                        else
                        {
                            ...
                            (void)sprintf_s(propText, sizeof(propText), tempString);
                            if (Map_AddOrUpdate(propMap, "temperature", propText) != MAP_OK)
                            {
                                (void)printf("ERROR: Map_AddOrUpdate Failed!\r\n");
                            }
